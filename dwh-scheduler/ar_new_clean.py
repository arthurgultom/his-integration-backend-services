...
print(f'Year: {year}')
print(f'Month: {month_yesterday}')
print(f'Day: {day_yesterday}')


# ============================================================================
# Query AS400 Database
# ============================================================================
count_query = """
    SELECT COUNT(*) as total 
    FROM HMI17P001.ARFP02 T01 
    LEFT JOIN hmi17p001.arfp00 T02 
        ON T01.compa2 = T02.compa0 AND T01.custa2 = T02.custa0 
...
try:
    ...
    # Get total count
    cursor_as400.execute(count_query, (year, month))
    total_rows = cursor_as400.fetchone()[0]
    print(f'Total rows to process: {total_rows}')
    
    # Fetch all data
    cursor_as400.execute(data_query, (year, month))
...
try:
    ...
    for row in ar_data:
        try:
            ...
            if success_count % 100 == 0:
                print(f"Processed {success_count}/{total_rows} rows...")
    ...
    print(f"Insert completed: {success_count} success, {error_count} errors")
