...
AND    PRDCE0            =     '40'               
 ...
 #AND   	 GVDRGS        	<>     ''    
 #AND   	 TTYPGS           =     '2' 
#AND 	 LEFT(CUSTA0,1) LIKE '%P%'
#AND    T01.REFPA2        <>     'C' 

 #AND    (INYYE1*10000)+(INMME1*100)+(INDDE1) between 20150101 and 20150731
 #AND    (INYYE1)+(INMME1)+(INDDE1) between """+str(todaydate)+""" and """+str(todaydate)+"""
 # AND INYYE1="+str(YY1)+" and INMME1="+str(MM1)+" and INDDE1="+str(DD1)+"
 # (CUSTA0 IN ('PJARM1'))
 #AND 	(INYYE1*10000)				= """+str(yeard)+"""
 #AND 	(INMME1)		= """+str(monthd)+"""
#AND 	INDDE1						= """+str(dayd)+"""
