...
try:
    ...
    con_hino_bi = mysql.connector.connect(host='10.17.111.18',user='mysqlwb',password='mysqlwb',database='his_db_final_3')
...
if y == 0:
    ...
    try:
        conn_warranty = mysql.connector.connect(host='10.17.111.18',user='mysqlwb',password='mysqlwb',database='his_db_final_3')
