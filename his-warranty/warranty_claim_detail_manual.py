...
try:
    ...
    FROM
    HMI17P001.WAFP00 T01 LEFT JOIN (
    SELECT
    * FROM	HMI17P001.WAFP07 T02
    WHERE T02.TXTFW7 = 'D'
    AND T02.LINEW7 = 1
    ...
    LEFT JOIN HMI17P001.WAFP26 T03 ON
    T01.COMPW0 = T03.COMPWQ
    AND T01.WARPW0 = T03.WARPWQ
    AND T01.WARPW0 = T03.WARPWQ
    AND T01.WAR#W0 = T03.WAR#WQ
    LEFT JOIN HMI17P001.INFP07 T05 ON
    T01.VIN#W0 = T05.VIN#I7
    LEFT JOIN HMI17P001.INFP04 T06 ON
    T01.CAUSW0 = T06.ITEMI4
    LEFT JOIN HMI17P001.WAFP60 T07 ON
